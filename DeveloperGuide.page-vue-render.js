...
with(this){return _c('h3',{attrs:{"id":"implementation-of-single-optional-appointment-field"}},[_v("Implementation of Single, optional Appointment Field"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#implementation-of-single-optional-appointment-field","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('em',[_v("{Explain how "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Appointment")]),_v(" as an optional field is implemented}")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{Explain how "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Appointment")]),_v(" is stored inside each "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Person")]),_v("}")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Aspect: Parsing of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Appointment")]),_v(" Field")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Alternative 1 (current choice):")]),_v(" Use of raw "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("String")]),_v(" format for Appointment")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Far easier to parse and store as an object.")]),_v(" "),_c('li',[_v("Cons: Hard to extend upon in future use-cases, such as reminders, etc.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 2:")]),_v(" Use of "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DateTime")]),_v("-related objects for Appointment")]),_v(" "),_c('ul',[_c('li',[_v("Pros: More direct paths of feature extension in the long run.")]),_v(" "),_c('li',[_v("Cons: Translation to and from "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DateTime")]),_v(" objects can be non-trivial.")])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Sat, 28 Oct 2023, 12:05:58 GMT+8]")])])])}
}];
